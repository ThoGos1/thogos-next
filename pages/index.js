  ...
  return (
    <div className="grid">
      ...
      <svg width="200" height="204.5" viewBox="0 0 798 816" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="376.739" y="360.139" width="44.5217" height="136.904" fill="white"/>
        <rect x="321.087" y="396.87" width="44.5217" height="155.826" transform="rotate(-90 321.087 396.87)" fill="white"/>
        <circle cx="399" cy="128" r="128" fill="url(#paint2_linear_13_95)"/>
        <rect x="376.739" y="80.1392" width="44.5217" height="136.904" fill="white"/>
        <rect x="321.087" y="116.87" width="44.5217" height="155.826" transform="rotate(-90 321.087 116.87)" fill="white"/>
        <circle cx="128" cy="688" r="128" fill="url(#paint3_linear_13_95)"/>
        <rect x="105.739" y="640.139" width="44.5217" height="136.904" fill="white"/>
        <rect x="50.0869" y="676.87" width="44.5217" height="155.826" transform="rotate(-90 50.0869 676.87)" fill="white"/>
        <circle cx="399" cy="688" r="128" fill="url(#paint4_linear_13_95)"/>
        <rect x="376.739" y="640.139" width="44.5217" height="136.904" fill="white"/>
        <rect x="321.087" y="676.87" width="44.5217" height="155.826" transform="rotate(-90 321.087 676.87)" fill="white"/>
        <circle cx="670" cy="128" r="128" fill="url(#paint5_linear_13_95)"/>
        <rect x="647.739" y="80.1392" width="44.5217" height="136.904" fill="white"/>
        <rect x="592.087" y="116.87" width="44.5217" height="155.826" transform="rotate(-90 592.087 116.87)" fill="white"/>
        <circle cx="670" cy="688" r="128" fill="url(#paint6_linear_13_95)"/>
        <rect x="647.739" y="640.139" width="44.5217" height="136.904" fill="white"/>
        <rect x="592.087" y="676.87" width="44.5217" height="155.826" transform="rotate(-90 592.087 676.87)" fill="white"/>
        <circle cx="670" cy="408" r="128" fill="url(#paint7_linear_13_95)"/>
        <rect x="647.739" y="360.139" width="44.5217" height="136.904" fill="white"/>
        <rect x="592.087" y="396.87" width="44.5217" height="155.826" transform="rotate(-90 592.087 396.87)" fill="white"/>
        <circle cx="128" cy="408" r="128" fill="url(#paint8_linear_13_95)"/>
        <rect x="105.739" y="360.139" width="44.5217" height="136.904" fill="white"/>
        <rect x="50.0869" y="396.87" width="44.5217" height="155.826" transform="rotate(-90 50.0869 396.87)" fill="white"/>
        <defs>
        ...
        <stop offset="0.880208" stopColor="#272081"/>
        </linearGradient>
        ...
        <stop offset="0.71875" stopColor="#A32CDB"/>
        </linearGradient>
        </defs>
      </svg>
